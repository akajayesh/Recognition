...
REGISTER_FILE = 'registered_palm_left.json'
...
with mp_hands.Hands(
    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks and is_right_hand(results):
        ...
        if key == 27:
            break
        elif key == ord('r') and results.multi_hand_landmarks and is_right_hand(results):
